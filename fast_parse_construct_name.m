...
cell_var_names = {'oligo_id',...
    ...
    'upstream_region_id',...
    'dnstream_region_id',...
    'upstream_sequence_derivation',...
    'dnstream_sequence_derivation'};
...
T{up_gt_10kb_idx,'upstream_sequence_derivation'} = {'enhancer_derived'};
T{~up_gt_10kb_idx,'upstream_sequence_derivation'} = {'promoter_derived'};
...
T{dn_gt_10kb_idx,'dnstream_sequence_derivation'} = {'enhancer_derived'};
T{~dn_gt_10kb_idx,'dnstream_sequence_derivation'} = {'promoter_derived'};
